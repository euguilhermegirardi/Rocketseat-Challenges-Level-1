...
In this challenge, I must create an application to practice what I have learned in Node.js!

This will be an application to storage repositories of my portfolio, that will allow me to list, update, and delete repositories, and besides that, the repositories can also receive likes.
...
In each test, I had a brief description of what your application must do in order for the test suits pass.

For this challenge I have the following tests:

- **`should be able to create a new repository`**: In order for this test to pass, my application must allow a repository to be created, and return a JSON with the created project.
...
<p align="center">
  <img  src=".github/challenge-node.png">
</p>
